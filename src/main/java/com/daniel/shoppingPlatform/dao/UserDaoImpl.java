...
public class UserDaoImpl implements UserDao {
	...
	public User getUserById(Integer userId) {
		...
		String sql = "SELECT user_id, email, password, created_date, last_modified_date FROM mall.user WHERE user_id = :userId";
	...
	public User getUserByEmail(String email) {
		...
		String sql = "SELECT user_id, email, password, created_date, last_modified_date FROM mall.user WHERE email = :email";
